...
if __name__ == "__main__":
    ...
    template_file = (
        "/usr/workspace/vargas58/orca_test/templates/omol_REFERENCE.inp"  # 300 step
    )
    ...
    template_file = (
        "/usr/workspace/vargas58/orca_test/templates/dk3_omol.inp"  # 300 step
    )
    ...
    template_file = (
        "/usr/workspace/vargas58/orca_test/templates/dk3_omol_pbe0.inp"  # 300 step
    )
    ...
    template_file = (
        "/usr/workspace/vargas58/orca_test/templates/dk3_omol_tpss.inp"  # 300 step
    )
